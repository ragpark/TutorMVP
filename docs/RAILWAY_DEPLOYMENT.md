...
After deployment, run `pnpm db:seed` once from the API service shell to create demo users and Algebra Foundations curriculum. If Redis is absent locally, worker behavior falls back synchronously for MVP jobs.
